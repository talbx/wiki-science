...
public class JSONTopicsMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException {
        ...
        StringTokenizer tokenizer = new StringTokenizer(wikiArticle.getTitle());
